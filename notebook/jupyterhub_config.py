...
c.GenericOAuthenticator.client_id = config("CLIENT_ID")
c.GenericOAuthenticator.client_secret =config("CLIENT_SECRET")
...
c.GenericOAuthenticator.userdata_url = 'http://localhost:8000/api/userdata'
